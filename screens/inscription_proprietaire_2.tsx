  ...
  const nextPage = () => {
    ...
    if (stepper == 4) {
      ...
      navigation.navigate('inscription_proprietaire_3', {
        etablissement: {
          ...route.params?.etablissement,
          postcode: '',
          sciem: sciem,
          nom_prenom_responsable: nom_prenom_responsable,
              ...
              <View
                ...
                <View
                  ...
                  <TextInput
                    ...
                    defaultValue={sciem}
                    onChangeText={input => setSciem(input)}
                    style={{
                      backgroundColor: 'transparent',
                      borderBottomWidth: 1,
                ...
                <View
                  ...
                  <TextInput
                    ...
                    onChangeText={input => setNPR(input)}
                    style={{
                      backgroundColor: 'transparent',
                      borderBottomWidth: 1,
                      borderBottomColor: couleurs.primary,
                ...
                <View
                  ...
                  <TextInput
                    ...
                    onChangeText={input => setPO(input)}
                    style={{
                      backgroundColor: 'transparent',
                      borderBottomWidth: 1,
                      borderBottomColor: couleurs.primary,
