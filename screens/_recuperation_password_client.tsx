...
import CloseIcon from '../components/close';
  ...
  export default function RecuperationPasswordClient({
    navigation,
  }: {
    navigation: any;
  }) {
  ...
  //////////////////////////////////////////////////////////////////////////////////////
    ...
    const [isVisiblePasswordValModal, setVisiblePasswordValModal] = useState(false)
    ...
    return (
      <>
       <SafeAreaView
          ...
          <Modal transparent={true} visible={isProccessing} style={{backgroundColor:'rgba(100,100,100,.3)'}}>
            <View
              style={{
                flex: 1,
         ...
         <View
              ...
              <Text style={{  fontFamily: CustomFont.Poppins, fontSize:13, marginVertical:10, paddingHorizontal: 15  }}>
